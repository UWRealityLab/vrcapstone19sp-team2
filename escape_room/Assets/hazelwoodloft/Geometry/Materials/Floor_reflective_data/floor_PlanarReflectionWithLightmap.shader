...
_ReflFactor ("Reflection Factor", Range(0.0,1.0)) = 0.1
...
#include "floor_AngryInclude.cginc"
...
//i.scr.xy += normals.xy;
return color + _ReflFactor*tex2D(_ReflectionTex, i.scr.xy);// + texCUBE(_CubeReflTex, reflectVector) * 0.1;
}
